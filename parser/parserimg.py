...
class Parser(object):
    ...
    #guarda el postit i para la imagen original "path" dado un Mat img. Retorna la ruta final relativa a la carpeta de donde se corre
    ...
    def findPostits(self, img, imgc2, rects, postits):
        ...
        for cnt in contours:
            ...
            if area>min_postit and area < min_postit*20 and len(cnt) < 6 and cv2.isContourConvex(cnt):
