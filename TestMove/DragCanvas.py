...
#----------------------------------------------------------------------
# objeto que representa una imagen
class DragShape:
...
class DragCanvas(wx.ScrolledWindow):
    def __init__(self, parent, ID, backgroundImage, arrImage):
        ...
        for x in range(len(arrImage)):
            bmp = wx.Image(opj(arrImage[x]), wx.BITMAP_TYPE_PNG).ConvertToBitmap()
